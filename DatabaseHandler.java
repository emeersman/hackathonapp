...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "profsManager";
 
    // Profs table name
    private static final String TABLE_CONTACTS = "profs";
    ...
    void addProf(Prof prof) {
        ...
        values.put(KEY_NAME, prof.getName()); // Prof Name
        values.put(KEY_PH_NO, prof.getSchool()); // Prof Phone
    ...
    public List<Prof> getAllProfs() {
        ...
        if (cursor.moveToFirst()) {
            do {
                Prof prof = new Prof();
                prof.setID(Integer.parseInt(cursor.getString(0)));
                prof.setName(cursor.getString(1));
                prof.setSchool(cursor.getString(2));
                // Adding prof to list
                profList.add(prof);
